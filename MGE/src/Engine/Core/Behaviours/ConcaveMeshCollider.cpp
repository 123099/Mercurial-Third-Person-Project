...
void ConcaveMeshCollider::SetupCollisionShape()
{
	...
	for (int i = 0; i < vertexCount - 3; i+=3)
	{
		...
		const glm::vec3 v3 = vertices[i + 2];
	...
	const glm::vec3 v1 = vertices[vertexCount - 3];
	const glm::vec3 v2 = vertices[vertexCount - 2];
	const glm::vec3 v3 = vertices[vertexCount - 1];
	m_triangleMesh->addTriangle(
		btVector3(v1.x, v1.y, v1.z),
		btVector3(v2.x, v2.y, v2.z),
		btVector3(v3.x, v3.y, v3.z),
